...
export default class SortableTable {
  ...
  constructor(header = [], {url = ""}) {
      ...
      this.column = 'title';
      this.orderSort = 'asc';
      this.url = new URL(this.path, BACKEND_URL);
      this.render();
  }
  ...
  async requestData() {
      ...
      this.url.searchParams.set('_sort', this.column);
      this.url.searchParams.set('_order', this.orderSort);
      this.url.searchParams.set('_start', this.paramStart);
      this.url.searchParams.set('_end', this.paramEnd);

      const arrData = await fetchJson(this.url);
